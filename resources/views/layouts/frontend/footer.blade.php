    ...
    <footer class="bg-gray-100 py-8">
        <div class="container mx-auto px-4">
          <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              <h3 class="font-bold text-lg mb-4">ReserveEasy</h3>
              <p class="text-gray-600">
                Making service booking simple and efficient for everyone.
              </p>
            </div>
            ...
            <div>
              ...
              <p class="text-gray-600">
                ...
                Reservation City, RC 12345<br />
                info@reserveeasy.com
              </p>
            </div>
          </div>

          <div class="border-t border-gray-200 mt-8 pt-8 text-center text-gray-500">
              <p>&copy; 2023 ReserveEasy. All rights reserved.</p>
          </div>
      </div>
  </footer>
